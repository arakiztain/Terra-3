...
const Chatbot = () => {
  ...
  const predefinedResponses = [
    ...
    "Categorización de la Issue: Tipo de incidencia: Corrección de errores (Bug fix)"
  ];
  const toggleChat = () => {
    setIsOpen(!isOpen);
  };
